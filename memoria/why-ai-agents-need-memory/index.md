...
![AI assistant without memory is like a forgetful barista](./images/coffee-shop.png)
...
![Different types of human memory](./images/brain-memory-types.png)
...
![AI without memory keeps making the same mistakes](./images/ai-fails.png)
...
![Memory transforms AI from a tool into a relationship](./images/tool-vs-relationship.png)
